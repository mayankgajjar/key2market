...
class ConnectionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $connections = new Connections([
                ...
                'user_name' => encryption_decryption_data(strip_tags($request->get('user_name')),'e'),
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $connections->client_id = $request->get('client_id');
            ...
            $connections->user_name = encryption_decryption_data(strip_tags($request->get('user_name')),'e');
            ...
            $connections->save();
            return redirect()->route('connection.index',$request->get('client_id'))->with('message', 'Connection Updated successfully !');
        }
        catch (\Exception $e) {
