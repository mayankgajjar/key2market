...
class MonitorController extends Controller
{
    ...
    public function index($id)
    {
        try {
            ...
            $table_data = DB::table('dim_tables')
                        ->join('dim_connections', 'dim_connections.id', '=', 'dim_tables.connection_id')
                        ->select('dim_tables.*', 'dim_connections.connection_name')
                        ->where('dim_tables.client_id', $id)
    ...
    public function create($id)
    {
        ...
        $postData = '';
        $params = array(
            'connection_type' => encryption_decryption_data($connection_info['connection_type'],'d'),
            'host' => encryption_decryption_data($connection_info['host'],'d'),
            'username' => encryption_decryption_data($connection_info['user_name'],'d'),
            'database' => encryption_decryption_data($connection_info['database'],'d'),
            'password' => encryption_decryption_data($connection_info['password'],'d'),
            'port' => encryption_decryption_data($connection_info['port'],'d'),
        );
        ...
        if($params['connection_type'] == 'postgres'){
            ...
            if($response == 'Not connected'){
                return redirect()->back()->with('message', 'The system is not able to connect this database, please check connection details.');
            } else {
    ...
    {   
        ...
        return redirect()->route('monitor.index',$client_id)->with('message', 'Table Data Added successfully !');
    }
    ...
    public function edit($id)
    {
        /*try {*/
            ...
            if($params['connection_type'] == 'postgres'){
                ...
                if (in_array($schema, $tschema)){
                    ...
                    $table_data = array();
                    $table_schemas = array();
                    $massage = 'Schema Not Found in Database.';
                }
        ...
        return view('user.monitor.edit',compact('table_data','id','user_data','table_schemas','table_data_db','schema_data','massage'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('monitor.index',$request->get('client_id'))->with('message', 'Table Data Updated successfully !');
    }
    ...
    public function table(Request $request, $id) {
        ...
        return view('user.monitor.showtable',compact('connection_info','id','user_data','table_data','schema'));
