...
jQuery.validator.addMethod("phonenumber", function (value, element) {
 ...
 /*Validate Phone number field..[author KU]*/
jQuery.validator.addMethod("first_email", function (value, element) {
    return this.optional(element) || /^[A-Za-z0-9]/.test(value);
},"The first character of your email should be a letter (a-z) or number.");

jQuery.validator.addMethod("extension",function(a,b,c){
	return c="string"==typeof c?c.replace(/,/g,"|"):"png|jpe?g",
...
jQuery.validator.addMethod("userval", function(value, element, regexpr) {
...
jQuery.validator.addMethod("wordMin",
...
//add the custom validation method
jQuery.validator.addMethod("wordMax",
   function(value, element, params) {
      var count = getWordCount(value);
      if(count < params[0]) {
         return true;
