        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    @else 
                       <a class="navbar-brand" href="{{route('pipe.index',$user_data->id)}}" style="background: #eee;margin: 0 0  0 20px;">Data Pipes</a>
                       <a class="navbar-brand" href="{{route('pipe.inactive',$user_data->id)}}" style="background: #eee;margin: 0 0  0 20px;">Inactive Data Pipes</a>
                    @endguest
                </div>
